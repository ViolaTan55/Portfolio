  ...
  return (
    <div>
      ...
      <Col style={{ maxWidth: "1100px"}}>
        ...
        <img src="/Assets/ProjectPages/Transformable/2find1.gif" className="img-fluid" style={{width:"80%", maxWidth: "1100px", paddingBottom: 30}}/>
      ...
      <p className="project-description" style={{ textAlign: "center" }}>
        ...
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_01.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>
        ...
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_02.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>

        <p className="project-description" style={{ paddingBottom: 15,textAlign: "center" }}>
        A Seifert Surface is an orientable surface whose boundary is defined by a knot or a link.
        </p>

        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_03.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>
        <p className="project-description" style={{ paddingBottom: 15,textAlign: "center" }}>
        ...
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_04.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>
        ...
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_05.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>
        ...
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_06.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>
        ...
        <img src="/Assets/ProjectPages/Transformable/2find1.gif" className="img-fluid" style={{width:"80%", maxWidth: "1100px", paddingTop: 30,paddingBottom: 30}}/>
        <p className="project-description" style={{ paddingBottom: 15,textAlign: "center" }}>
        ...
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_07.png" className="img-fluid" style={{width:"80%", maxWidth: "1100px", paddingTop: 15, paddingBottom:30}}/>
        <p className="project-description" style={{ paddingBottom: 15,textAlign: "center" }}>
        ...
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_08.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>
        <p className="project-description" style={{ paddingBottom: 15,textAlign: "center" }}>
        ...
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_09.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_10.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>
        <img src="/Assets/ProjectPages/Transformable/Transformable_Page_11.png" className="img-fluid" style={{maxWidth: "1100px", paddingBottom: 15}}/>
